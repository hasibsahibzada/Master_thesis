...
%Sonny, Lenny, Glenn, Conny, Rejne, Bjarne, Bjor
%\usepackage[Sonny]{fncychap}
 \usepackage[Bjornstrup]{fncychap}
%\usepackage[Lenny]{fncychap}
%\usepackage[Bjor]{fncychap}
...
\usepackage{framed}
\usepackage{amsmath}
\definecolor{shadecolor}{RGB}{205,201,201}
...
%\include{Chapters/0/declaration}
...
%\noindent\enquote{\itshape Who are the learned? Those who practice what they know.}\bigbreak

%\hfill Prophet Muhammad (PBUH) 
...
%\include{Chapters/0/Aknowledgment}
...
\include{Chapters/3/AttractionAttention}
\include{Chapters/4/AdvertisementDecision}
\include{Chapters/5/AdvertisementLowFi}
\include{Chapters/6/AdvertisementHighFi}
\include{Chapters/7/AdvertisementApplication}
\include{Chapters/8/InteractiveNonInteractiveStudy}
\include{Chapters/9/InteractiveAdEnhancement}

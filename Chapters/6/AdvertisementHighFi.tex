...
\begin{figure}[H]
    \centering
    \subfloat[]{{\includegraphics[width=6cm,height=4cm]{Figures/6/singleBody} }}%
    \subfloat[]{{\includegraphics[width=6cm,height=4cm]{Figures/6/singleMobile} }}%
...
\begin{figure}[H]
    \centering
    \subfloat[]{{\includegraphics[width=6cm,height=4cm]{Figures/6/groupBody} }}%
    \subfloat[]{{\includegraphics[width=6cm,height=4cm]{Figures/6/groupMobile} }}%

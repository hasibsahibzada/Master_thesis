...
\multirow{2}{*}{Introduction}                 & \#1: Introduction                                                                                           \\ \cline{2-2} 
                                              & \#2: Background                                                                                             \\ \hline
\multirow{5}{*}{Pre Advertisement Comparison} & \#3: Attracting Attention Attraction                                                                                   \\ \cline{2-2} 
...
\multirow{2}{*}{Advertisement Comparison}     & \begin{tabular}[c]{@{}l@{}}\#8: Comparison of Interactive and \\ Non-Interactive Advertisement\end{tabular} \\ \cline{2-2} 
                                              & \begin{tabular}[c]{@{}l@{}}\#9: Design and evaluation of  \\ Enhanced Interactive Advertisement\end{tabular} \\ \hline

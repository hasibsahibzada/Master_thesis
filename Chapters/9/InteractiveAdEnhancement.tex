...
From entire passers-by 15.32\% of them were engaged with the display and the rest might have only glanced or simply ignored as shown in the chart below.
...
The numbers of engaged and non-engaged were recorded for all three conditions as below.
...
ANOVA reveals that there was statistical difference between these conditions, (\emph{(F2,3)=20.3154, p <.05 (p=0.0021)}), and to confirm that which of the pairs were different significantly, I run Post-Hoc Tukey’s HSD test as below.

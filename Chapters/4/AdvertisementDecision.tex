...
\begin{wrapfigure}[12]{r}{0.2\textheight} %this figure will be at the right
    \centering
...
\subsection{Reason of Bauhaus-Walk and advertisement}
...
\hilight{Note: See appendix C for sketches. }

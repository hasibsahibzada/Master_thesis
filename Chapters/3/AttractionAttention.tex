...
\begin{figure}[!htb]
    \centering
    \subfloat[]{{\includegraphics[width=50mm,height=40mm]{Figures/3/eyes} }}%
    \hfill
    \subfloat[]{{\includegraphics[width=50mm,height=40mm]{Figures/3/fireworks} }}%
...
\begin{figure}[!htb]
    \centering
    \subfloat[]{{\includegraphics[width=6cm]{Figures/3/Kasseturm_monitor} }}%
    \hfill
    \subfloat[]{{\includegraphics[width=6cm]{Figures/3/mensa_setup} }}%
...
\begin{figure}[!htb]
    \centering
    \subfloat[]{{\includegraphics[width=6cm,height=4cm]{Figures/3/hamid} }}%
    \hfill
    \subfloat[]{{\includegraphics[width=6cm,height=4cm]{Figures/3/observer} }}%
...
\label{tab:silhouttetraditional}
\centering
\begin{tabular}{l l l l }
\toprule
\tabhead{Method} & \tabhead{Glanced (\%)} & \tabhead{ingnored (\%)} & \tabhead{Total } \\
